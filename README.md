...
- **5 Specialized Agents** — Document, Financial, Academic, Hostel, Mentor
- **Admin Dashboard** — real-time analytics for college staff
- **Sentiment Detection** — detects confused students, escalates to counselors
